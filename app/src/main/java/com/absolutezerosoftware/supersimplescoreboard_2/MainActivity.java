...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        new AlertDialog.Builder(this)
                .setMessage(R.string.azsoftware_exit_question_string)
                .setCancelable(false)
                .setPositiveButton(R.string.azsoftware_yes_string, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        MainActivity.this.finish();
                    }
                })
                .setNegativeButton(R.string.azsoftware_no_string, null)
                .show();
    }
